...
### Distribution of Anxierty Indicators
```{r distribution of anxiety, warning=FALSE, echo=FALSE}
plot(anxiety_disorder_histogam)
```

This graph shows that the states's anxiety indicator value falls between 20 to 40. Most states (16 states) have a value of 30 indicating an anxiety disorder when this data was collected from Apr 23 to May 5, 2020. The lowest value of anxiety indicators was North Dakota at 21.7 while the highest was Massachusetts at 37.
